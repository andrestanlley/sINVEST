return {
    ...
    LiquidezCorrente: parseFloat(ticker.ResumoBalancoDFP[0]?.AtivoCirculante / (ticker.ResumoPrincipaisConta?.Passivo[1].UltExe * 1000)).toFixed(2),
    LiquidezImediata: parseFloat(ticker.ResumoBalancoDFP[0]?.Disponibilidades / (ticker.ResumoPrincipaisConta?.Passivo[1].UltExe * 1000)).toFixed(2),
